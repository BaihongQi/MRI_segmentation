#this file is only for cheak the correctness of part2
#I did not write any of the code in this file, it has been provided as a solution on e-class
#submitted with part2 for TA to test the correctness of part2
